...
func (x *GOODS_INFO) GetBoughtRecord() []uint32 {
	if x != nil {
...
var file_GOODS_INFO_proto_rawDesc = []byte{
	,
}

var (
	file_GOODS_INFO_proto_rawDescOnce sync.Once
	file_GOODS_INFO_proto_rawDescData = file_GOODS_INFO_proto_rawDesc
)

func file_GOODS_INFO_proto_rawDescGZIP() []byte {
	file_GOODS_INFO_proto_rawDescOnce.Do(func() {
		file_GOODS_INFO_proto_rawDescData = protoimpl.X.CompressGZIP(file_GOODS_INFO_proto_rawDescData)
	})
	return file_GOODS_INFO_proto_rawDescData
}

var file_GOODS_INFO_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_GOODS_INFO_proto_goTypes = []interface{}{
...
func file_GOODS_INFO_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_GOODS_INFO_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GOODS_INFO); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_GOODS_INFO_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_GOODS_INFO_proto_rawDesc = nil
