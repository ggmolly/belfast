...
var file_PLAYER_INFO_proto_rawDesc = []byte{
	0x0a, 0x11, 0x50, 0x4c, 0x41, 0x59, 0x45, 0x52, 0x5f, 0x49, 0x4e, 0x46, 0x4f, 0x2e, 0x70, 0x72,
	...
	0x71, 0x0a, 0x0b, 0x50, 0x4c, 0x41, 0x59, 0x45, 0x52, 0x5f, 0x49, 0x4e, 0x46, 0x4f, 0x12, 0x0e,
	...
	0x6d, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x6c, 0x76, 0x18, 0x03, 0x20, 0x02, 0x28, 0x0d, 0x52, 0x02,
	0x6c, 0x76, 0x12, 0x2e, 0x0a, 0x07, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x62, 0x65, 0x6c, 0x66, 0x61, 0x73, 0x74, 0x2e, 0x44, 0x49,
	0x53, 0x50, 0x4c, 0x41, 0x59, 0x49, 0x4e, 0x46, 0x4f, 0x52, 0x07, 0x64, 0x69, 0x73, 0x70, 0x6c,
	0x61, 0x79, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
}

var (
	file_PLAYER_INFO_proto_rawDescOnce sync.Once
	file_PLAYER_INFO_proto_rawDescData = file_PLAYER_INFO_proto_rawDesc
)

func file_PLAYER_INFO_proto_rawDescGZIP() []byte {
	file_PLAYER_INFO_proto_rawDescOnce.Do(func() {
		file_PLAYER_INFO_proto_rawDescData = protoimpl.X.CompressGZIP(file_PLAYER_INFO_proto_rawDescData)
	})
	return file_PLAYER_INFO_proto_rawDescData
}

var file_PLAYER_INFO_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_PLAYER_INFO_proto_goTypes = []interface{}{
...
func file_PLAYER_INFO_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_PLAYER_INFO_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PLAYER_INFO); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_PLAYER_INFO_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_PLAYER_INFO_proto_rawDesc = nil
