...
var file_SC_70002_proto_rawDesc = []byte{
	0x0a, 0x0e, 0x53, 0x43, 0x5f, 0x37, 0x30, 0x30, 0x30, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x12, 0x07, 0x62, 0x65, 0x6c, 0x66, 0x61, 0x73, 0x74, 0x22, 0x22, 0x0a, 0x08, 0x53, 0x43, 0x5f,
	0x37, 0x30, 0x30, 0x30, 0x32, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18,
...
var (
	...
	file_SC_70002_proto_rawDescData = file_SC_70002_proto_rawDesc
)

func file_SC_70002_proto_rawDescGZIP() []byte {
	file_SC_70002_proto_rawDescOnce.Do(func() {
		file_SC_70002_proto_rawDescData = protoimpl.X.CompressGZIP(file_SC_70002_proto_rawDescData)
	})
	return file_SC_70002_proto_rawDescData
}

var file_SC_70002_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_SC_70002_proto_goTypes = []interface{}{
...
func file_SC_70002_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_SC_70002_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SC_70002); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_SC_70002_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_SC_70002_proto_rawDesc = nil
