...
func registerPackets() {
	...
	packets.RegisterPacketHandler(11504, []packets.PacketHandler{answer.ChargeConfirmAnswer})
	packets.RegisterPacketHandler(11508, []packets.PacketHandler{answer.ExchangeCodeRedeem})
	packets.RegisterPacketHandler(11510, []packets.PacketHandler{answer.ChargeFailed})
	packets.RegisterPacketHandler(11513, []packets.PacketHandler{answer.RefundChargeAnswer})
