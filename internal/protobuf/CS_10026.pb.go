...
const file_CS_10026_proto_rawDesc = "" +
	"\n" +
	"\x0eCS_10026.proto\x12\abelfast\")\n" +
	"\bCS_10026\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x02(\rR\taccountIdB\fZ\n" +
	"./protobuf"

var (
	file_CS_10026_proto_rawDescOnce sync.Once
	file_CS_10026_proto_rawDescData []byte
)

func file_CS_10026_proto_rawDescGZIP() []byte {
	file_CS_10026_proto_rawDescOnce.Do(func() {
		file_CS_10026_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_CS_10026_proto_rawDesc), len(file_CS_10026_proto_rawDesc)))
	})
	return file_CS_10026_proto_rawDescData
}

var file_CS_10026_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_CS_10026_proto_goTypes = []any{
...
func file_CS_10026_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_CS_10026_proto_rawDesc), len(file_CS_10026_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
