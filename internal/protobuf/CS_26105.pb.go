...
const file_CS_26105_proto_rawDesc = "" +
	"\n" +
	"\x0eCS_26105.proto\x12\abelfast\x1a\x0eCS_26103.proto\"7\n" +
	"\bCS_26105\x12+\n" +
	"\acombine\x18\x01 \x03(\v2\x11.belfast.CS_26103R\acombineB\fZ\n" +
	"./protobuf"

var (
	file_CS_26105_proto_rawDescOnce sync.Once
	file_CS_26105_proto_rawDescData []byte
)

func file_CS_26105_proto_rawDescGZIP() []byte {
	file_CS_26105_proto_rawDescOnce.Do(func() {
		file_CS_26105_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_CS_26105_proto_rawDesc), len(file_CS_26105_proto_rawDesc)))
	})
	return file_CS_26105_proto_rawDescData
}

var file_CS_26105_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_CS_26105_proto_goTypes = []any{
...
func file_CS_26105_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_CS_26105_proto_rawDesc), len(file_CS_26105_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
