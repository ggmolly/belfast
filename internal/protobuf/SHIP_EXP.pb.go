...
const file_SHIP_EXP_proto_rawDesc = "" +
	"\n" +
	"\x0eSHIP_EXP.proto\x12\abelfast\"i\n" +
	"\bSHIP_EXP\x12\x17\n" +
	"\aship_id\x18\x01 \x02(\rR\x06shipId\x12\x10\n" +
	"\x03exp\x18\x02 \x02(\rR\x03exp\x12\x1a\n" +
	"\bintimacy\x18\x03 \x02(\rR\bintimacy\x12\x16\n" +
	"\x06energy\x18\x04 \x02(\rR\x06energyB\fZ\n" +
	"./protobuf"

var (
	file_SHIP_EXP_proto_rawDescOnce sync.Once
	file_SHIP_EXP_proto_rawDescData []byte
)

func file_SHIP_EXP_proto_rawDescGZIP() []byte {
	file_SHIP_EXP_proto_rawDescOnce.Do(func() {
		file_SHIP_EXP_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SHIP_EXP_proto_rawDesc), len(file_SHIP_EXP_proto_rawDesc)))
	})
...
func file_SHIP_EXP_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SHIP_EXP_proto_rawDesc), len(file_SHIP_EXP_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
