...
const file_SC_12024_proto_rawDesc = "" +
	"\n" +
	"\x0eSC_12024.proto\x12\abelfast\x1a\x0fBUILDINFO.proto\"\xd7\x01\n" +
	"\bSC_12024\x12%\n" +
	"\x0eworklist_count\x18\x01 \x02(\rR\rworklistCount\x127\n" +
	"\rworklist_list\x18\x02 \x03(\v2\x12.belfast.BUILDINFOR\fworklistList\x12 \n" +
	"\fdraw_count_1\x18\x03 \x02(\rR\n" +
	"drawCount1\x12\"\n" +
	"\rdraw_count_10\x18\x04 \x02(\rR\vdrawCount10\x12%\n" +
	"\x0eexchange_count\x18\x05 \x02(\rR\rexchangeCountB\fZ\n" +
	"./protobuf"

var (
	file_SC_12024_proto_rawDescOnce sync.Once
	file_SC_12024_proto_rawDescData []byte
)

func file_SC_12024_proto_rawDescGZIP() []byte {
	file_SC_12024_proto_rawDescOnce.Do(func() {
		file_SC_12024_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SC_12024_proto_rawDesc), len(file_SC_12024_proto_rawDesc)))
	})
...
func file_SC_12024_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SC_12024_proto_rawDesc), len(file_SC_12024_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
