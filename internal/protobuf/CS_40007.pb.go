...
const file_CS_40007_proto_rawDesc = "" +
	"\n" +
	"\x0eCS_40007.proto\x12\abelfast\"D\n" +
	"\bCS_40007\x12\x16\n" +
	"\x06system\x18\x01 \x02(\rR\x06system\x12\x0e\n" +
	"\x02id\x18\x02 \x02(\rR\x02id\x12\x10\n" +
	"\x03cnt\x18\x03 \x02(\rR\x03cntB\fZ\n" +
	"./protobuf"

var (
	file_CS_40007_proto_rawDescOnce sync.Once
	file_CS_40007_proto_rawDescData []byte
)

func file_CS_40007_proto_rawDescGZIP() []byte {
	file_CS_40007_proto_rawDescOnce.Do(func() {
		file_CS_40007_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_CS_40007_proto_rawDesc), len(file_CS_40007_proto_rawDesc)))
	})
...
func file_CS_40007_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_CS_40007_proto_rawDesc), len(file_CS_40007_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
