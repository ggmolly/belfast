...
const file_CS_17607_proto_rawDesc = "" +
	"\n" +
	"\x0eCS_17607.proto\x12\abelfast\"c\n" +
	"\bCS_17607\x12\x1c\n" +
	"\tshipgroup\x18\x01 \x02(\rR\tshipgroup\x12\x18\n" +
	"\ashareid\x18\x02 \x02(\rR\ashareid\x12\x1f\n" +
	"\vreport_type\x18\x03 \x02(\rR\n" +
	"reportTypeB\fZ\n" +
	"./protobuf"

var (
	file_CS_17607_proto_rawDescOnce sync.Once
	file_CS_17607_proto_rawDescData []byte
)

func file_CS_17607_proto_rawDescGZIP() []byte {
	file_CS_17607_proto_rawDescOnce.Do(func() {
		file_CS_17607_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_CS_17607_proto_rawDesc), len(file_CS_17607_proto_rawDesc)))
	})
	return file_CS_17607_proto_rawDescData
}

var file_CS_17607_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_CS_17607_proto_goTypes = []any{
...
func file_CS_17607_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_CS_17607_proto_rawDesc), len(file_CS_17607_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
