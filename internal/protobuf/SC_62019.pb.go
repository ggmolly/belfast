...
const file_SC_62019_proto_rawDesc = "" +
	"\n" +
	"\x0eSC_62019.proto\x12\abelfast\"z\n" +
	"\bSC_62019\x12\x0e\n" +
	"\x02id\x18\x01 \x02(\rR\x02id\x12\x17\n" +
	"\auser_id\x18\x02 \x02(\rR\x06userId\x12\x1f\n" +
	"\vhas_capital\x18\x03 \x02(\rR\n" +
	"hasCapital\x12$\n" +
	"\x0ehas_tech_point\x18\x04 \x02(\rR\fhasTechPointB\fZ\n" +
	"./protobuf"

var (
	file_SC_62019_proto_rawDescOnce sync.Once
	file_SC_62019_proto_rawDescData []byte
)

func file_SC_62019_proto_rawDescGZIP() []byte {
	file_SC_62019_proto_rawDescOnce.Do(func() {
		file_SC_62019_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SC_62019_proto_rawDesc), len(file_SC_62019_proto_rawDesc)))
	})
	return file_SC_62019_proto_rawDescData
}

var file_SC_62019_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_SC_62019_proto_goTypes = []any{
...
func file_SC_62019_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SC_62019_proto_rawDesc), len(file_SC_62019_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
