...
const file_SC_26120_proto_rawDesc = "" +
	"\n" +
	"\x0eSC_26120.proto\x12\abelfast\x1a\x0eGAMEROOM.proto\"\xc2\x01\n" +
	"\bSC_26120\x12\x1f\n" +
	"\vweekly_free\x18\x01 \x02(\rR\n" +
	"weeklyFree\x12%\n" +
	"\x0emonthly_ticket\x18\x02 \x02(\rR\rmonthlyTicket\x12'\n" +
	"\x05rooms\x18\x03 \x03(\v2\x11.belfast.GAMEROOMR\x05rooms\x12$\n" +
	"\x0epay_coin_count\x18\x04 \x02(\rR\fpayCoinCount\x12\x1f\n" +
	"\vfirst_enter\x18\x05 \x02(\rR\n" +
	"firstEnterB\fZ\n" +
	"./protobuf"

var (
	file_SC_26120_proto_rawDescOnce sync.Once
	file_SC_26120_proto_rawDescData []byte
)

func file_SC_26120_proto_rawDescGZIP() []byte {
	file_SC_26120_proto_rawDescOnce.Do(func() {
		file_SC_26120_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SC_26120_proto_rawDesc), len(file_SC_26120_proto_rawDesc)))
	})
...
func file_SC_26120_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SC_26120_proto_rawDesc), len(file_SC_26120_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
