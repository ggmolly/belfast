...
const file_SC_10019_proto_rawDesc = "" +
	"\n" +
	"\x0eSC_10019.proto\x12\abelfast\x1a\x10SERVERINFO.proto\"?\n" +
	"\bSC_10019\x123\n" +
	"\n" +
	"serverlist\x18\x01 \x03(\v2\x13.belfast.SERVERINFOR\n" +
	"serverlistB\fZ\n" +
	"./protobuf"

var (
	file_SC_10019_proto_rawDescOnce sync.Once
	file_SC_10019_proto_rawDescData []byte
)

func file_SC_10019_proto_rawDescGZIP() []byte {
	file_SC_10019_proto_rawDescOnce.Do(func() {
		file_SC_10019_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SC_10019_proto_rawDesc), len(file_SC_10019_proto_rawDesc)))
	})
...
func file_SC_10019_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SC_10019_proto_rawDesc), len(file_SC_10019_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
