...
const file_IDTIMEINFO_proto_rawDesc = "" +
	"\n" +
	"\x10IDTIMEINFO.proto\x12\abelfast\"0\n" +
	"\n" +
	"IDTIMEINFO\x12\x0e\n" +
...
var (
	...
	file_IDTIMEINFO_proto_rawDescData []byte
)

func file_IDTIMEINFO_proto_rawDescGZIP() []byte {
	file_IDTIMEINFO_proto_rawDescOnce.Do(func() {
		file_IDTIMEINFO_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_IDTIMEINFO_proto_rawDesc), len(file_IDTIMEINFO_proto_rawDesc)))
	})
...
func file_IDTIMEINFO_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_IDTIMEINFO_proto_rawDesc), len(file_IDTIMEINFO_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
