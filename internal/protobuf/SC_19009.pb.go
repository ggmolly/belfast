...
const file_SC_19009_proto_rawDesc = "" +
	"\n" +
	"\x0eSC_19009.proto\x12\abelfast\"?\n" +
	"\bSC_19009\x12\x10\n" +
	"\x03exp\x18\x01 \x02(\rR\x03exp\x12!\n" +
	"\ffood_consume\x18\x02 \x02(\rR\vfoodConsumeB\fZ\n" +
	"./protobuf"

var (
	file_SC_19009_proto_rawDescOnce sync.Once
	file_SC_19009_proto_rawDescData []byte
)

func file_SC_19009_proto_rawDescGZIP() []byte {
	file_SC_19009_proto_rawDescOnce.Do(func() {
		file_SC_19009_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SC_19009_proto_rawDesc), len(file_SC_19009_proto_rawDesc)))
	})
	return file_SC_19009_proto_rawDescData
}

var file_SC_19009_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_SC_19009_proto_goTypes = []any{
...
func file_SC_19009_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SC_19009_proto_rawDesc), len(file_SC_19009_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
