...
const file_SC_18101_proto_rawDesc = "" +
	"\n" +
	"\x0eSC_18101.proto\x12\abelfast\x1a\x0fARENASHOP.proto\"\x8f\x01\n" +
	"\bSC_18101\x12\x1f\n" +
	"\vflash_count\x18\x01 \x02(\rR\n" +
	"flashCount\x12:\n" +
	"\x0farena_shop_list\x18\x02 \x03(\v2\x12.belfast.ARENASHOPR\rarenaShopList\x12&\n" +
	"\x0fnext_flash_time\x18\x03 \x02(\rR\rnextFlashTimeB\fZ\n" +
	"./protobuf"

var (
	file_SC_18101_proto_rawDescOnce sync.Once
	file_SC_18101_proto_rawDescData []byte
)

func file_SC_18101_proto_rawDescGZIP() []byte {
	file_SC_18101_proto_rawDescOnce.Do(func() {
		file_SC_18101_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SC_18101_proto_rawDesc), len(file_SC_18101_proto_rawDesc)))
	})
	return file_SC_18101_proto_rawDescData
}

var file_SC_18101_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_SC_18101_proto_goTypes = []any{
...
func file_SC_18101_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SC_18101_proto_rawDesc), len(file_SC_18101_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
