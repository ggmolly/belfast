...
const file_STRENGTH_INFO_proto_rawDesc = "" +
	"\n" +
	"\x13STRENGTH_INFO.proto\x12\abelfast\"1\n" +
	"\rSTRENGTH_INFO\x12\x0e\n" +
...
var (
	...
	file_STRENGTH_INFO_proto_rawDescData []byte
)

func file_STRENGTH_INFO_proto_rawDescGZIP() []byte {
	file_STRENGTH_INFO_proto_rawDescOnce.Do(func() {
		file_STRENGTH_INFO_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_STRENGTH_INFO_proto_rawDesc), len(file_STRENGTH_INFO_proto_rawDesc)))
	})
...
func file_STRENGTH_INFO_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_STRENGTH_INFO_proto_rawDesc), len(file_STRENGTH_INFO_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
