...
const file_DROPINFO_proto_rawDesc = "" +
	"\n" +
	"\x0eDROPINFO.proto\x12\abelfast\"F\n" +
	"\bDROPINFO\x12\x12\n" +
	"\x04type\x18\x01 \x02(\rR\x04type\x12\x0e\n" +
	"\x02id\x18\x02 \x02(\rR\x02id\x12\x16\n" +
	"\x06number\x18\x03 \x02(\rR\x06numberB\fZ\n" +
	"./protobuf"

var (
	file_DROPINFO_proto_rawDescOnce sync.Once
	file_DROPINFO_proto_rawDescData []byte
)

func file_DROPINFO_proto_rawDescGZIP() []byte {
	file_DROPINFO_proto_rawDescOnce.Do(func() {
		file_DROPINFO_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_DROPINFO_proto_rawDesc), len(file_DROPINFO_proto_rawDesc)))
	})
	return file_DROPINFO_proto_rawDescData
}

var file_DROPINFO_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_DROPINFO_proto_goTypes = []any{
...
func file_DROPINFO_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_DROPINFO_proto_rawDesc), len(file_DROPINFO_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
