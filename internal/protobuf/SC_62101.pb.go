...
const file_SC_62101_proto_rawDesc = "" +
	"\n" +
	"\x0eSC_62101.proto\x12\abelfast\x1a\x16GUILD_TECHNOLOGY.proto\"G\n" +
	"\bSC_62101\x12;\n" +
	"\vtechnologys\x18\x01 \x03(\v2\x19.belfast.GUILD_TECHNOLOGYR\vtechnologysB\fZ\n" +
	"./protobuf"

var (
	file_SC_62101_proto_rawDescOnce sync.Once
	file_SC_62101_proto_rawDescData []byte
)

func file_SC_62101_proto_rawDescGZIP() []byte {
	file_SC_62101_proto_rawDescOnce.Do(func() {
		file_SC_62101_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SC_62101_proto_rawDesc), len(file_SC_62101_proto_rawDesc)))
	})
...
func file_SC_62101_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SC_62101_proto_rawDesc), len(file_SC_62101_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
