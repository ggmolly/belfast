...
const file_CS_10018_proto_rawDesc = "" +
	"\n" +
	"\x0eCS_10018.proto\x12\abelfast\"\x1c\n" +
	"\bCS_10018\x12\x10\n" +
...
var (
	...
	file_CS_10018_proto_rawDescData []byte
)

func file_CS_10018_proto_rawDescGZIP() []byte {
	file_CS_10018_proto_rawDescOnce.Do(func() {
		file_CS_10018_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_CS_10018_proto_rawDesc), len(file_CS_10018_proto_rawDesc)))
	})
	return file_CS_10018_proto_rawDescData
}

var file_CS_10018_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_CS_10018_proto_goTypes = []any{
	(*CS_10018)(nil), // 0: belfast.CS_10018
}
...
func file_CS_10018_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_CS_10018_proto_rawDesc), len(file_CS_10018_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
