...
const file_SC_63308_proto_rawDesc = "" +
	"\n" +
	"\x0eSC_63308.proto\x12\abelfast\"A\n" +
	"\bSC_63308\x12\x16\n" +
...
var (
	...
	file_SC_63308_proto_rawDescData []byte
)

func file_SC_63308_proto_rawDescGZIP() []byte {
	file_SC_63308_proto_rawDescOnce.Do(func() {
		file_SC_63308_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SC_63308_proto_rawDesc), len(file_SC_63308_proto_rawDesc)))
	})
...
func file_SC_63308_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SC_63308_proto_rawDesc), len(file_SC_63308_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
