...
const file_CS_10800_proto_rawDesc = "" +
	"\n" +
	"\x0eCS_10800.proto\x12\abelfast\"<\n" +
	"\bCS_10800\x12\x14\n" +
...
var (
	...
	file_CS_10800_proto_rawDescData []byte
)

func file_CS_10800_proto_rawDescGZIP() []byte {
	file_CS_10800_proto_rawDescOnce.Do(func() {
		file_CS_10800_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_CS_10800_proto_rawDesc), len(file_CS_10800_proto_rawDesc)))
	})
...
func file_CS_10800_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_CS_10800_proto_rawDesc), len(file_CS_10800_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
