...
const file_ATTIRE_INFO_proto_rawDesc = "" +
	"\n" +
	"\x11ATTIRE_INFO.proto\x12\abelfast\"8\n" +
	"\vATTIRE_INFO\x12\x0e\n" +
...
var (
	...
	file_ATTIRE_INFO_proto_rawDescData []byte
)

func file_ATTIRE_INFO_proto_rawDescGZIP() []byte {
	file_ATTIRE_INFO_proto_rawDescOnce.Do(func() {
		file_ATTIRE_INFO_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ATTIRE_INFO_proto_rawDesc), len(file_ATTIRE_INFO_proto_rawDesc)))
	})
	return file_ATTIRE_INFO_proto_rawDescData
}

var file_ATTIRE_INFO_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ATTIRE_INFO_proto_goTypes = []any{
...
func file_ATTIRE_INFO_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ATTIRE_INFO_proto_rawDesc), len(file_ATTIRE_INFO_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
