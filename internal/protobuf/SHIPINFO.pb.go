...
type SHIPINFO struct {
	...
	MaxLevel            *uint32                `protobuf:"varint,19,req,name=max_level,json=maxLevel" json:"max_level,omitempty"`
	CommonFlag          *uint32                `protobuf:"varint,20,opt,name=common_flag,json=commonFlag" json:"common_flag,omitempty"`
	ActivityNpc         *uint32                `protobuf:"varint,21,req,name=activity_npc,json=activityNpc" json:"activity_npc,omitempty"`
	MetaRepairList      []uint32               `protobuf:"varint,22,rep,name=meta_repair_list,json=metaRepairList" json:"meta_repair_list,omitempty"`
	Spweapon            *SPWEAPONINFO          `protobuf:"bytes,23,opt,name=spweapon" json:"spweapon,omitempty"`
	SkinShadowList      []*KVDATA              `protobuf:"bytes,24,rep,name=skin_shadow_list,json=skinShadowList" json:"skin_shadow_list,omitempty"`
	CharRandomFlag      []uint32               `protobuf:"varint,25,rep,name=char_random_flag,json=charRandomFlag" json:"char_random_flag,omitempty"`
...
func (x *SHIPINFO) GetSkinShadowList() []*KVDATA {
	if x != nil {
...
func (x *SHIPINFO) GetCharRandomFlag() []uint32 {
	if x != nil {
...
const file_SHIPINFO_proto_rawDesc = "" +
	...
	"\x15change_name_timestamp\x18\x12 \x01(\rR\x13changeNameTimestamp\x12\x1b\n" +
	"\tmax_level\x18\x13 \x02(\rR\bmaxLevel\x12\x1f\n" +
	"\vcommon_flag\x18\x14 \x01(\rR\n" +
	"commonFlag\x12!\n" +
	"\factivity_npc\x18\x15 \x02(\rR\vactivityNpc\x12(\n" +
	"\x10meta_repair_list\x18\x16 \x03(\rR\x0emetaRepairList\x121\n" +
	"\bspweapon\x18\x17 \x01(\v2\x15.belfast.SPWEAPONINFOR\bspweapon\x129\n" +
	"\x10skin_shadow_list\x18\x18 \x03(\v2\x0f.belfast.KVDATAR\x0eskinShadowList\x12(\n" +
	"\x10char_random_flag\x18\x19 \x03(\rR\x0echarRandomFlagB\fZ\n" +
	"./protobuf"

var (
	file_SHIPINFO_proto_rawDescOnce sync.Once
	file_SHIPINFO_proto_rawDescData []byte
)

func file_SHIPINFO_proto_rawDescGZIP() []byte {
	file_SHIPINFO_proto_rawDescOnce.Do(func() {
		file_SHIPINFO_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SHIPINFO_proto_rawDesc), len(file_SHIPINFO_proto_rawDesc)))
	})
...
func file_SHIPINFO_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SHIPINFO_proto_rawDesc), len(file_SHIPINFO_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
