...
const file_SC_26112_proto_rawDesc = "" +
	"\n" +
	"\x0eSC_26112.proto\x12\abelfast\x1a\x11FRIENDSCORE.proto\"6\n" +
	"\bSC_26112\x12*\n" +
	"\x05ranks\x18\x01 \x03(\v2\x14.belfast.FRIENDSCORER\x05ranksB\fZ\n" +
	"./protobuf"

var (
	file_SC_26112_proto_rawDescOnce sync.Once
	file_SC_26112_proto_rawDescData []byte
)

func file_SC_26112_proto_rawDescGZIP() []byte {
	file_SC_26112_proto_rawDescOnce.Do(func() {
		file_SC_26112_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SC_26112_proto_rawDesc), len(file_SC_26112_proto_rawDesc)))
	})
...
func file_SC_26112_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SC_26112_proto_rawDesc), len(file_SC_26112_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
