...
const file_SC_11503_proto_rawDesc = "" +
	"\n" +
	"\x0eSC_11503.proto\x12\abelfast\"g\n" +
	"\bSC_11503\x12\x17\n" +
	"\ashop_id\x18\x01 \x02(\rR\x06shopId\x12\x15\n" +
...
var (
	...
	file_SC_11503_proto_rawDescData []byte
)

func file_SC_11503_proto_rawDescGZIP() []byte {
	file_SC_11503_proto_rawDescOnce.Do(func() {
		file_SC_11503_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SC_11503_proto_rawDesc), len(file_SC_11503_proto_rawDesc)))
	})
...
func file_SC_11503_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SC_11503_proto_rawDesc), len(file_SC_11503_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
