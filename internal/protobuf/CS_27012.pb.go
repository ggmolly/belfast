...
const file_CS_27012_proto_rawDesc = "" +
	"\n" +
	"\x0eCS_27012.proto\x12\abelfast\x1a\x15CHILD_PLAN_CELL.proto\":\n" +
	"\bCS_27012\x12.\n" +
	"\x05plans\x18\x01 \x03(\v2\x18.belfast.CHILD_PLAN_CELLR\x05plansB\fZ\n" +
	"./protobuf"

var (
	file_CS_27012_proto_rawDescOnce sync.Once
	file_CS_27012_proto_rawDescData []byte
)

func file_CS_27012_proto_rawDescGZIP() []byte {
	file_CS_27012_proto_rawDescOnce.Do(func() {
		file_CS_27012_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_CS_27012_proto_rawDesc), len(file_CS_27012_proto_rawDesc)))
	})
...
func file_CS_27012_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_CS_27012_proto_rawDesc), len(file_CS_27012_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
