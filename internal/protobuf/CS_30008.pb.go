...
const file_CS_30008_proto_rawDesc = "" +
	"\n" +
	"\x0eCS_30008.proto\x12\abelfast\"#\n" +
	"\bCS_30008\x12\x17\n" +
	"\amail_id\x18\x01 \x02(\rR\x06mailIdB\fZ\n" +
	"./protobuf"

var (
	file_CS_30008_proto_rawDescOnce sync.Once
	file_CS_30008_proto_rawDescData []byte
)

func file_CS_30008_proto_rawDescGZIP() []byte {
	file_CS_30008_proto_rawDescOnce.Do(func() {
		file_CS_30008_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_CS_30008_proto_rawDesc), len(file_CS_30008_proto_rawDesc)))
	})
...
func file_CS_30008_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_CS_30008_proto_rawDesc), len(file_CS_30008_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
