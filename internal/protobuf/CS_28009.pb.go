...
const file_CS_28009_proto_rawDesc = "" +
	"\n" +
	"\x0eCS_28009.proto\x12\abelfast\x1a\x19APARTMENT_GIVE_GIFT.proto\"]\n" +
	"\bCS_28009\x12\x1d\n" +
	"\n" +
	"ship_group\x18\x01 \x02(\rR\tshipGroup\x122\n" +
	"\x05gifts\x18\x02 \x03(\v2\x1c.belfast.APARTMENT_GIVE_GIFTR\x05giftsB\fZ\n" +
	"./protobuf"

var (
	file_CS_28009_proto_rawDescOnce sync.Once
	file_CS_28009_proto_rawDescData []byte
)

func file_CS_28009_proto_rawDescGZIP() []byte {
	file_CS_28009_proto_rawDescOnce.Do(func() {
		file_CS_28009_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_CS_28009_proto_rawDesc), len(file_CS_28009_proto_rawDesc)))
	})
...
func file_CS_28009_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_CS_28009_proto_rawDesc), len(file_CS_28009_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
