...
const file_CS_19008_proto_rawDesc = "" +
	"\n" +
	"\x0eCS_19008.proto\x12\abelfast\x1a\x16FURNITUREPUTINFO.proto\"i\n" +
	"\bCS_19008\x12\x14\n" +
...
var (
	...
	file_CS_19008_proto_rawDescData []byte
)

func file_CS_19008_proto_rawDescGZIP() []byte {
	file_CS_19008_proto_rawDescOnce.Do(func() {
		file_CS_19008_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_CS_19008_proto_rawDesc), len(file_CS_19008_proto_rawDesc)))
	})
...
func file_CS_19008_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_CS_19008_proto_rawDesc), len(file_CS_19008_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
