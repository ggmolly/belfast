...
const file_EVENT_PERFORMANCE_proto_rawDesc = "" +
	"\n" +
	"\x17EVENT_PERFORMANCE.proto\x12\abelfast\"D\n" +
	"\x11EVENT_PERFORMANCE\x12\x19\n" +
	"\bevent_id\x18\x01 \x02(\rR\aeventId\x12\x14\n" +
	"\x05index\x18\x02 \x02(\rR\x05indexB\fZ\n" +
	"./protobuf"

var (
	file_EVENT_PERFORMANCE_proto_rawDescOnce sync.Once
	file_EVENT_PERFORMANCE_proto_rawDescData []byte
)

func file_EVENT_PERFORMANCE_proto_rawDescGZIP() []byte {
	file_EVENT_PERFORMANCE_proto_rawDescOnce.Do(func() {
		file_EVENT_PERFORMANCE_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_EVENT_PERFORMANCE_proto_rawDesc), len(file_EVENT_PERFORMANCE_proto_rawDesc)))
	})
	return file_EVENT_PERFORMANCE_proto_rawDescData
}

var file_EVENT_PERFORMANCE_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_EVENT_PERFORMANCE_proto_goTypes = []any{
...
func file_EVENT_PERFORMANCE_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_EVENT_PERFORMANCE_proto_rawDesc), len(file_EVENT_PERFORMANCE_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
