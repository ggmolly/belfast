...
const file_SC_27038_proto_rawDesc = "" +
	"\n" +
	"\x0eSC_27038.proto\x12\abelfast\"\"\n" +
	"\bSC_27038\x12\x16\n" +
...
var (
	...
	file_SC_27038_proto_rawDescData []byte
)

func file_SC_27038_proto_rawDescGZIP() []byte {
	file_SC_27038_proto_rawDescOnce.Do(func() {
		file_SC_27038_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SC_27038_proto_rawDesc), len(file_SC_27038_proto_rawDesc)))
	})
	return file_SC_27038_proto_rawDescData
}

var file_SC_27038_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_SC_27038_proto_goTypes = []any{
...
func file_SC_27038_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SC_27038_proto_rawDesc), len(file_SC_27038_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
