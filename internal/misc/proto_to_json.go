...
func ProtoToJson(packetId int, data *[]byte) (string, error) {
	...
	case 13302:
		...
		output, err = json.MarshalIndent(p, "", "	")
	case 28005:
		var p protobuf.CS_28005
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 30014:
		var p protobuf.CS_30014
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 28008:
		var p protobuf.SC_28008
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 28007:
		var p protobuf.CS_28007
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	...
	case 27030:
		...
		output, err = json.MarshalIndent(p, "", "	")
	case 11029:
		var p protobuf.CS_11029
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 28011:
		var p protobuf.CS_28011
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 28004:
		var p protobuf.SC_28004
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 30013:
		var p protobuf.SC_30013
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 30016:
		var p protobuf.CS_30016
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 11212:
		var p protobuf.CS_11212
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 28013:
		var p protobuf.CS_28013
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 26161:
		var p protobuf.SC_26161
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 28012:
		var p protobuf.SC_28012
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 30017:
		var p protobuf.SC_30017
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	...
	case 27002:
		...
		output, err = json.MarshalIndent(p, "", "	")
	case 28003:
		var p protobuf.CS_28003
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 30012:
		var p protobuf.CS_30012
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	...
	case 26102:
		...
		output, err = json.MarshalIndent(p, "", "	")
	case 28006:
		var p protobuf.SC_28006
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 30015:
		var p protobuf.SC_30015
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 30018:
		var p protobuf.CS_30018
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 28009:
		var p protobuf.CS_28009
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 28010:
		var p protobuf.SC_28010
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 30019:
		var p protobuf.SC_30019
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 26160:
		var p protobuf.CS_26160
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 28015:
		var p protobuf.CS_28015
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 28000:
		var p protobuf.SC_28000
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
	case 28014:
		var p protobuf.SC_28014
		if err = proto.Unmarshal(*data, &p); err != nil {
			return "", err
		}
		output, err = json.MarshalIndent(p, "", "	")
